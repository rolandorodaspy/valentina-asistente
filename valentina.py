...
# Cargar claves API desde secrets
...
if audio_file is not None:
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as tmp_audio:
        ...
        chat_response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "Sos Valentina, una asistente cálida y amable que responde con claridad y cariño."},
        ...
        try:
            ...
            if audio_bytes and len(audio_bytes) > 1000:
                ...
                st.warning("⚠️ No se pudo reproducir el audio. El archivo está vacío o corrupto.")
